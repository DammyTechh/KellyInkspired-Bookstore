...
const AdminLoginPage = () => {
  ...
  useEffect(() => {
    document.title = 'Admin Login | KellyInkspired';
  }, []);
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200"
                required
              />
            </div>
